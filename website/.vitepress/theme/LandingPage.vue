...
const translations = {
  en: {
    ...
    nav_install: "Install",
    nav_tech: "Tech Stack",
    hero_badge: "v8.0.0 - Claude Code 2.1.107",
    ...
    feat_3_desc: "Use 204 slash commands to automate tedious tasks. Generate components, check architecture, and run pre-commit audits.",
  ...
  fr: {
    ...
    feat_3_desc: "Utilisez 204 commandes pour automatiser les t\u00e2ches fastidieuses.",
  ...
  es: {
    ...
    hero_badge: "v8.0.0 - Claude Code 2.1.107", hero_title_1: "Potencia", hero_title_2: "con Conocimiento Experto",
    ...
    feat_skills_title: "41 Skills", feat_skills_desc: "Mejores pr\u00e1cticas en formato oficial de Claude Code.",
    feat_3_title: "Flujos Automatizados", feat_3_desc: "Usa 204 comandos para automatizar tareas.",
  ...
  de: {
    ...
    hero_badge: "v8.0.0 - Claude Code 2.1.107", hero_title_1: "Laden Sie", hero_title_2: "mit Expertenwissen auf",
    ...
    feat_skills_title: "41 Skills", feat_skills_desc: "Best Practices im offiziellen Claude Code Format.",
    feat_3_title: "Automatisierte Abl\u00e4ufe", feat_3_desc: "204 Befehle f\u00fcr Automatisierung.",
  ...
  pt: {
    ...
    hero_badge: "v8.0.0 - Claude Code 2.1.107", hero_title_1: "Turbine o", hero_title_2: "com Conhecimento Especializado",
    ...
    feat_skills_title: "41 Skills", feat_skills_desc: "Melhores pr\u00e1ticas no formato oficial do Claude Code.",
    feat_3_title: "Fluxos Automatizados", feat_3_desc: "Use 204 comandos para automatizar tarefas.",
    ...
    <section id="features" style="padding: 5rem 0; background: #1e293b;">
      <div style="max-width: 80rem; margin: 0 auto; padding: 0 1.5rem;">
        ...
        <div class="grid-3col" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
          <FeatureCard icon="git-branch" color="cyan" :badge="'v8.0.0'" :title="t('feat_bmad_title')" :desc="t('feat_bmad_desc')" />
          <FeatureCard icon="repeat" color="orange" :badge="'v8.0.0'" :title="t('feat_ralph_title')" :desc="t('feat_ralph_desc')" />
