...
const translations = {
  en: {
    ...
    nav_install: "Install",
    nav_tech: "Tech Stack",
    hero_badge: "v8.20.0 - Claude Code 2.1.193",
  ...
  es: {
    ...
    hero_badge: "v8.20.0 - Claude Code 2.1.193", hero_title_1: "Potencia", hero_title_2: "con Conocimiento Experto",
  ...
  de: {
    ...
    hero_badge: "v8.20.0 - Claude Code 2.1.193", hero_title_1: "Laden Sie", hero_title_2: "mit Expertenwissen auf",
  ...
  pt: {
    ...
    hero_badge: "v8.20.0 - Claude Code 2.1.193", hero_title_1: "Turbine o", hero_title_2: "com Conhecimento Especializado",
    ...
    <section id="features" style="padding: 5rem 0; background: #1e293b;">
      <div style="max-width: 80rem; margin: 0 auto; padding: 0 1.5rem;">
        ...
        <div class="grid-3col" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
          <FeatureCard icon="git-branch" color="cyan" :badge="'v8.20.0'" :title="t('feat_bmad_title')" :desc="t('feat_bmad_desc')" />
          <FeatureCard icon="repeat" color="orange" :badge="'v8.20.0'" :title="t('feat_ralph_title')" :desc="t('feat_ralph_desc')" />
