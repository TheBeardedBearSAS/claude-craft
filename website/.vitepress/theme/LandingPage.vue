...
const translations = {
  en: {
    ...
    nav_install: "Install",
    nav_tech: "Tech Stack",
    hero_badge: "v8.22.0 - Claude Code 2.1.251",
  ...
  es: {
    ...
    hero_badge: "v8.22.0 - Claude Code 2.1.251", hero_title_1: "Potencia", hero_title_2: "con Conocimiento Experto",
  ...
  de: {
    ...
    hero_badge: "v8.22.0 - Claude Code 2.1.251", hero_title_1: "Laden Sie", hero_title_2: "mit Expertenwissen auf",
  ...
  pt: {
    ...
    hero_badge: "v8.22.0 - Claude Code 2.1.251", hero_title_1: "Turbine o", hero_title_2: "com Conhecimento Especializado",
