...
const translations = {
  en: {
    ...
    nav_install: "Install",
    nav_tech: "Tech Stack",
    hero_badge: "v7.17.1 - Claude Code 2.1.47",
    ...
    feat_3_desc: "Use 161 slash commands to automate tedious tasks. Generate components, check architecture, and run pre-commit audits.",
  ...
  fr: {
    ...
    feat_3_desc: "Utilisez 161 commandes pour automatiser les t\u00e2ches fastidieuses.",
  ...
  es: {
    ...
    hero_badge: "v7.17.1 - Claude Code 2.1.47", hero_title_1: "Potencia", hero_title_2: "con Conocimiento Experto",
    ...
    feat_3_title: "Flujos Automatizados", feat_3_desc: "Usa 161 comandos para automatizar tareas.",
  ...
  de: {
    ...
    hero_badge: "v7.17.1 - Claude Code 2.1.47", hero_title_1: "Laden Sie", hero_title_2: "mit Expertenwissen auf",
    ...
    feat_3_title: "Automatisierte Abl\u00e4ufe", feat_3_desc: "161 Befehle f\u00fcr Automatisierung.",
  ...
  pt: {
    ...
    hero_badge: "v7.17.1 - Claude Code 2.1.47", hero_title_1: "Turbine o", hero_title_2: "com Conhecimento Especializado",
    ...
    feat_3_title: "Fluxos Automatizados", feat_3_desc: "Use 161 comandos para automatizar tarefas.",
    ...
    <section id="features" style="padding: 5rem 0; background: #1e293b;">
      <div style="max-width: 80rem; margin: 0 auto; padding: 0 1.5rem;">
        ...
        <div class="grid-3col" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
          <FeatureCard icon="git-branch" color="cyan" :badge="'v7.17.1'" :title="t('feat_bmad_title')" :desc="t('feat_bmad_desc')" />
          <FeatureCard icon="repeat" color="orange" :badge="'v7.17.1'" :title="t('feat_ralph_title')" :desc="t('feat_ralph_desc')" />
