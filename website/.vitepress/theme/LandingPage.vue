...
const translations = {
  en: {
    ...
    nav_install: "Install",
    nav_tech: "Tech Stack",
    hero_badge: "v7.11.0 - Claude Code 2.1.41",
  ...
  es: {
    ...
    hero_badge: "v7.11.0 - Claude Code 2.1.41", hero_title_1: "Potencia", hero_title_2: "con Conocimiento Experto",
  ...
  de: {
    ...
    hero_badge: "v7.11.0 - Claude Code 2.1.41", hero_title_1: "Laden Sie", hero_title_2: "mit Expertenwissen auf",
  ...
  pt: {
    ...
    hero_badge: "v7.11.0 - Claude Code 2.1.41", hero_title_1: "Turbine o", hero_title_2: "com Conhecimento Especializado",
    ...
    <div style="position: relative; padding: 10rem 0 5rem; overflow: hidden;">
      ...
      <div style="max-width: 80rem; margin: 0 auto; padding: 0 1.5rem; text-align: center; position: relative;">
        ...
        <div style="margin-top: 2.5rem; display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
          ...
          <a href="/en/getting-started/quickstart" style="display: inline-flex; align-items: center; padding: 0.75rem 2rem; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.05); color: #cbd5e1; border-radius: 0.5rem; text-decoration: none; font-weight: 500; font-size: 1.125rem; backdrop-filter: blur(4px);">
            {{ t('cta_docs') }}
          </a>
        </div>
