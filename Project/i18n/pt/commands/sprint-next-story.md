...
Ordem de prioridade:
1. Stories sem dependencias bloqueadoras
2. ID de story menor (mais cedo no backlog)
3. Story points menores (mais simples primeiro)
...
Comandos:
  /sprint:bmad-status    Ver o status completo do sprint
