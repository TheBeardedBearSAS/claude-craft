...
MSG_MENU_CC_FUNC="cc() Funktion installieren"
...
MSG_USAGE_OR_CC="Oder die cc() Funktion falls hinzugefügt:"
MSG_USAGE_LANG_DESC="Sprache (en, fr, es, de, pt)"

# cc() function
MSG_CC_TITLE="cc() Funktion installieren"
MSG_CC_ALREADY="cc() Funktion ist bereits installiert"
MSG_CC_ADDED="cc() Funktion hinzugefügt zu"
