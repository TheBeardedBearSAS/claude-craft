...
MSG_MENU_CC_FUNC="Instalar función cc()"
...
MSG_USAGE_OR_CC="O la función cc() si está añadida:"
MSG_USAGE_LANG_DESC="Idioma (en, fr, es, de, pt)"

# cc() function
MSG_CC_TITLE="Instalar función cc()"
MSG_CC_ALREADY="La función cc() ya está instalada"
MSG_CC_ADDED="Función cc() añadida a"
MSG_CC_USAGE="Uso:"
