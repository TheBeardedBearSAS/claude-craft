...
MSG_MENU_CC_FUNC="Instalar função cc()"
...
MSG_USAGE_OR_CC="Ou a função cc() se adicionada:"
MSG_USAGE_LANG_DESC="Língua (en, fr, es, de, pt)"

# cc() function
MSG_CC_TITLE="Instalar função cc()"
MSG_CC_ALREADY="A função cc() já está instalada"
MSG_CC_ADDED="Função cc() adicionada a"
