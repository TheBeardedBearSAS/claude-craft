# Model Context Protocol (MCP) Integration - Flutter 3.44+

## Overview

Le **Model Context Protocol (MCP)** est un standard ouvert pour l'intégration d'assistants AI dans les applications. Flutter 3.44+ offre un support natif pour créer des applications qui interagissent avec des AI assistants comme Claude.
