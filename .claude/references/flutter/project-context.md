...
- Options : Riverpod 3.x (recommandé) / BLoC 9.x / Provider / GetX
...
```dart
// Compilation WebAssembly activée par défaut pour web
// flutter build web --wasm (production)
// flutter run -d chrome --wasm (dev)
```

#### Model Context Protocol (MCP) pour AI
```dart
// Intégration AI assistants via MCP
...
| Windows | 10 21H2+ | ARM64 support |
| Linux | Ubuntu 22.04+ | Wayland natif |
| Web | Chrome 120+, Edge 120+ | WebAssembly GC |
