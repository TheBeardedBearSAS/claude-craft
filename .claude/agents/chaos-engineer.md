...
| **Remediation** | Ajouter health checks, augmenter replicas |
...
| **L4 - Continuous** | Chaos 24/7 en prod, auto-remediation |
...
- Migration vers microservices (tester fault tolerance)
- Mise en place circuit breakers / retries
...
- `@performance-auditor` — optimiser après détection bottlenecks via chaos
