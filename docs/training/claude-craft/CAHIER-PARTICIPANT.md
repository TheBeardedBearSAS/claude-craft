# Cahier du Participant - Formation Claude Code 2.1.105 + Claude-Craft 7.26.0
...
- [ ] Installer et configurer Claude Code 2.1.105
- [ ] Utiliser les nouvelles fonctionnalités (Plan Mode, Hooks, Background Tasks)
- [ ] Installer Claude-Craft 7.26.0 via npx (structure TCL)
...
### Module 2 : Le Framework Claude-Craft 7.26.0
...
|------------|---|---|---|---|---|
| Installation Claude Code 2.1.105 | | | | | |
| Utilisation Plan Mode | | | | | |
| Installation Claude-Craft 7.26.0 (npx) | | | | | |
| Compréhension TCL | | | | | |
...
- [ ] Installer Claude-Craft 7.26.0 sur mon projet
