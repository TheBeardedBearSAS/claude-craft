...
| **Opus 4.8** | $$$ ($5/$25 par M tokens) | Architecture complexe, flagship, effort `xhigh` |
...
9. **Haiku 4.5 pour le simple, Sonnet 4.6 pour le quotidien, Opus 4.8 pour le complexe**
