# Proposition Commerciale : Formation Claude Code 2.1.159 — Maîtriser l'Agent de Développement
...
| Claude-Craft | 8.8.0 | Mentionné en bonus démo uniquement |
...
| **9. Bonus — Claude-Craft** | 30min | Démo du framework Claude-Craft 8.8.0. Agents spécialisés (70 agents, 125 commandes / 15 namespaces). Workflow BMAD v6 : de l'analyse au déploiement. Quand et pourquoi adopter un framework sur Claude Code. |
