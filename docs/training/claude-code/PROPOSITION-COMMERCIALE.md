...
| **9. Bonus — Claude-Craft** | 30min | Démo du framework Claude-Craft 8.3.1. Agents spécialisés (72 agents, 211 commandes). Workflow BMAD v6 : de l'analyse au déploiement. Quand et pourquoi adopter un framework sur Claude Code. |
