...
This guide covers the utility tools included with Claude-Craft for managing profiles, status display, project configuration, and Claude Code commands and features (v7.25.0).
...
Claude Code supports 24 hook events (8 new in v7.25.0) for automating workflows:
