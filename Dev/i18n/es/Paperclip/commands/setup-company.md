...
> El CLI `paperclipai` real (v2026.609.0) **no** expone un comando `companies create`. La creación de compañía ocurre a través del dashboard o importando un paquete con `paperclipai company import`. No inventar flags que no existen — abrir `paperclipai company --help` y seguir lo que hay ahí.
...
Paperclip envía con adaptadores built-in (observado v2026.609.0):
...
Paperclip **no** contrata agentes desde un archivo YAML vía CLI (en v2026.609.0). Contratar un agente:
