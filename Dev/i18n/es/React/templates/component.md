...
interface ComponentNameProps {
  ...
  /**
   * Callback llamado durante la acción
   */
  onAction?: () => void;
...
// Exportar tipo para reutilización
export type { ComponentNameProps };
```

## Con Variantes (class-variance-authority)
...
// ComponentNamePresenter.tsx (Componente Tonto)
import { FC } from 'react';
...
├── hooks/                     # Hooks locales (si es necesario)
│   └── useCustomLogic.ts
