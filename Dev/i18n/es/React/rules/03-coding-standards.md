...
> **⚠️ ESLint v10 (2026):** El formato `.eslintrc.cjs` está **eliminado**. Usar `eslint.config.mjs` (flat config). Ver la sección de herramientas para el ejemplo de migración.
