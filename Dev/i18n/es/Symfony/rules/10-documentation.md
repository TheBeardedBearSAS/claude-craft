# Documentación - Atoll Tourisme

## Descripción general

La documentación es **OBLIGATORIA** y debe redactarse en **FRANCÉS** (excepto ejemplos de código).

**Principios:**
- ✅ Documentación actualizada (código = documentación)
- ✅ Francés para documentación de usuario/negocio
- ✅ Inglés para código/comentarios técnicos
- ✅ ADR para decisiones arquitectónicas importantes
- ✅ README completo y estructurado

> **Referencias:**
> - `03-coding-standards.md` - Reglas de idioma (código EN, docs FR)
> - `02-architecture-clean-ddd.md` - Arquitectura a documentar

---

## Tabla de contenidos

1. [Estándares de documentación](#estándares-de-documentación)
2. [Estructura README](#estructura-readme)
3. [PHPDoc](#phpdoc)
...
| Tipo | Idioma | Ejemplo |
|------|--------|---------|
| Código (variables, métodos, clases) | 🇬🇧 Inglés | `calculateTotalPrice()`, `ReservationId` |
| Comentarios código | 🇬🇧 Inglés | `// Calculate discount for family` |
| PHPDoc (@param, @return) | 🇬🇧 Inglés | `@param Money $amount The amount to add` |
| Documentación usuario | 🇫🇷 Francés | README.md, guías |
| Documentación negocio | 🇫🇷 Francés | ADR, especificaciones |
| Mensajes de error (end-user) | 🇫🇷 Francés | "Réservation non trouvée" |
| Logs (técnicos) | 🇬🇧 Inglés | "Reservation confirmed" |
...
### Tags PHPDoc obligatorios

| Tag | Uso | Obligatorio |
|-----|-------|-------------|
| `@param` | Parámetros método | Sí si parámetro |
| `@return` | Tipo de retorno | Sí si no void |
| `@throws` | Excepciones lanzadas | Sí si excepción |
| `@var` | Tipo variable | Si tipo complejo |
| `@see` | Referencias | Si pertinente |
| `@deprecated` | Método obsoleto | Si deprecado |
| `@since` | Versión introducción | Clases públicas |
| `@author` | Autor | Clases principales |
...
**Décideurs:** [Nombres de las personas implicadas]

**Contexte technique:** [Versión Symfony, PHP, etc.]

## Contexte

[Describa el problema o la necesidad que requiere una decisión]

Ejemplo: Nous devons choisir comment stocker les montants monétaires dans l'application.
...
Ejemplo: Nous utiliserons un Value Object `Money` qui stocke les montants en centimes (entier)
