...
// ❌ DÉPRÉCIÉ depuis PHP 8.0 + DANGEREUX: la función deprecated n'annule pas les flags ci-dessous
...
security:
    # ✅ Password hasher seguro: sodium = Argon2id via libsodium (OWASP 2026)
    password_hashers:
