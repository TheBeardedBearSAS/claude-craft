...
description: Especialista en revisión de código Flutter 3.41 / Dart 3.11 — BLoC, Riverpod, optimización de widgets, código específico de plataforma
model: sonnet
...
```markdown
# Informe de auditoría Flutter 3.41 / Dart 3.11
