# Seguridad - Mejores Prácticas de React Native

## Introducción

La seguridad es crítica en las aplicaciones móviles que manipulan datos sensibles.
...
### 1. Prevenir Capturas de Pantalla (iOS/Android)
...
### Fase de Desarrollo
- [ ] Datos sensibles en SecureStore/Keychain
- [ ] Tokens de API asegurados
- [ ] Validación de entradas implementada (Zod)
- [ ] HTTPS forzado
- [ ] Variables de entorno configuradas
- [ ] Autenticación biométrica (si es necesario)
...
- [ ] Prevención de capturas de pantalla (si es necesario)
...
**La seguridad no es una funcionalidad, es una responsabilidad.**
