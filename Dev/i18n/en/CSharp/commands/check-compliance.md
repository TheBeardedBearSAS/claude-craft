---
description: Check Complete C#/.NET Compliance
argument-hint: [arguments]
---

# Check Complete C#/.NET Compliance
...
Perform a complete compliance audit of the C#/.NET project by orchestrating the 4 major checks: Architecture, Code Quality, Tests, and Security. Produce a consolidated report with an overall score out of 100 points.

### Step 1: Audit Preparation

Prepare audit environment:
- [ ] Identify project path to audit
- [ ] Verify presence of configuration files (.sln, .csproj, Directory.Build.props)
- [ ] List main directories (src/, tests/, etc.)
- [ ] Identify project structure and .NET version
...
**Command**: Use slash command `/csharp:check-architecture` or manually follow steps in `check-architecture.md`

**Evaluated Criteria**:
- Clean Architecture layer separation (6 pts)
- Dependency flow (Domain has no external refs) (6 pts)
- CQRS and MediatR patterns (4 pts)
- DDD modeling (Entities, Value Objects, Aggregates) (4 pts)
- Repository and Unit of Work patterns (3 pts)
- Project references and dependency rules (2 pts)
...
**Command**: Use slash command `/csharp:check-code-quality` or manually follow steps in `check-code-quality.md`

**Evaluated Criteria**:
- Naming conventions (PascalCase, _camelCase) (5 pts)
- Modern C# features (records, pattern matching) (5 pts)
- Nullable reference types enabled (4 pts)
- KISS/DRY/YAGNI principles (4 pts)
- Async/await patterns (no .Result/.Wait()) (4 pts)
- Documentation and XML comments (3 pts)
...
**Command**: Use slash command `/csharp:check-testing` or manually follow steps in `check-testing.md`

**Evaluated Criteria**:
- Code coverage (7 pts)
- Unit tests for Domain and Application (6 pts)
- Integration tests for Infrastructure (4 pts)
- FluentAssertions quality (3 pts)
- Test organization and fixtures (3 pts)
- Mocking patterns (Moq/NSubstitute) (2 pts)
...
**Command**: Use slash command `/csharp:check-security` or manually follow steps in `check-security.md`

**Evaluated Criteria**:
- OWASP Top 10 protections (6 pts)
- Secrets and credentials management (5 pts)
- Input validation (FluentValidation) (4 pts)
...
```
C#/.NET COMPLIANCE AUDIT - COMPLETE REPORT
=============================================
...
Sub-scores:
  ...
  • Dependency flow             : XX/6
  • CQRS and MediatR            : XX/4
  • DDD Modeling                : XX/4
  • Repository patterns         : XX/3
  • Project references          : XX/2
