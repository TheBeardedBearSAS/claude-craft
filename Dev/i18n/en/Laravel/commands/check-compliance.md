---
description: Check Complete Laravel Compliance
argument-hint: [arguments]
---

# Check Complete Laravel Compliance
...
Perform a complete compliance audit of the Laravel project by orchestrating the 4 major checks: Architecture, Code Quality, Tests, and Security. Produce a consolidated report with an overall score out of 100 points.

### Step 1: Audit Preparation

Prepare audit environment:
- [ ] Identify project path to audit
- [ ] Verify presence of configuration files (composer.json with laravel/*, .env.example)
- [ ] List main directories (app/, tests/, config/, routes/, etc.)
- [ ] Identify project structure and Laravel version
...
**Command**: Use slash command `/laravel:check-architecture` or manually follow steps in `check-architecture.md`

**Evaluated Criteria**:
- Clean Architecture layer separation (6 pts)
- Domain/Application/Infrastructure structure (6 pts)
- Actions pattern and thin controllers (4 pts)
- Service Provider bindings (4 pts)
- Repository pattern and interfaces (3 pts)
- Dependency rules (2 pts)
...
**Command**: Use slash command `/laravel:check-code-quality` or manually follow steps in `check-code-quality.md`

**Evaluated Criteria**:
- PSR-12 and Laravel Pint compliance (5 pts)
- PHPStan static analysis (5 pts)
- Modern PHP features (enums, readonly, typed properties) (4 pts)
- KISS/DRY/YAGNI principles (4 pts)
- Naming conventions (Laravel standards) (4 pts)
- Error handling and logging (3 pts)
...
**Command**: Use slash command `/laravel:check-testing` or manually follow steps in `check-testing.md`

**Evaluated Criteria**:
- Code coverage (7 pts)
- Unit tests for Domain logic (6 pts)
- Feature tests for HTTP endpoints (4 pts)
- Pest PHP usage and test quality (3 pts)
- Database factories and seeders (3 pts)
...
**Command**: Use slash command `/laravel:check-security` or manually follow steps in `check-security.md`

**Evaluated Criteria**:
- OWASP Top 10 protections (6 pts)
- Secrets and credentials management (5 pts)
- Form Request validation (4 pts)
- Dependency vulnerabilities (composer audit) (4 pts)
- Authentication and Authorization (Policies) (3 pts)
- CSRF and middleware configuration (2 pts)
...
```
LARAVEL COMPLIANCE AUDIT - COMPLETE REPORT
=============================================
...
Sub-scores:
  ...
  • Domain/App/Infra structure  : XX/6
  • Actions and thin controllers: XX/4
  • Service Provider bindings   : XX/4
  • Repository pattern          : XX/3
  • Dependency rules            : XX/2
