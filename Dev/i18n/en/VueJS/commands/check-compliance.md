---
description: Check Complete Vue.js Compliance
argument-hint: [arguments]
---

# Check Complete Vue.js Compliance
...
Perform a complete compliance audit of the Vue.js project by orchestrating the 4 major checks: Architecture, Code Quality, Tests, and Security. Produce a consolidated report with an overall score out of 100 points.
...
- [ ] List main directories (src/, tests/, public/, etc.)
- [ ] Identify project structure and Vue.js version
...
**Command**: Use slash command `/vuejs:check-architecture` or manually follow steps in `check-architecture.md`

**Evaluated Criteria**:
- Component and feature organization (6 pts)
- Composables structure and reuse (6 pts)
- Pinia store architecture (4 pts)
- Router configuration and lazy loading (4 pts)
- Shared/common module separation (3 pts)
- Dependency rules and barrel exports (2 pts)
...
**Command**: Use slash command `/vuejs:check-code-quality` or manually follow steps in `check-code-quality.md`

**Evaluated Criteria**:
- TypeScript strict mode and type safety (5 pts)
- ESLint and Prettier compliance (5 pts)
- Composition API and script setup usage (4 pts)
...
**Command**: Use slash command `/vuejs:check-testing` or manually follow steps in `check-testing.md`

**Evaluated Criteria**:
- Code coverage (7 pts)
- Unit tests for composables and stores (6 pts)
- Component tests with Vue Test Utils (4 pts)
- Integration tests (3 pts)
- Test quality and AAA pattern (3 pts)
- Mocks and fixtures organization (2 pts)
...
**Command**: Use slash command `/vuejs:check-security` or manually follow steps in `check-security.md`

**Evaluated Criteria**:
- XSS prevention (v-html usage) (6 pts)
...
- Secure API communication (2 pts)
- CSRF protection (1 pt)
...
```
VUE.JS COMPLIANCE AUDIT - COMPLETE REPORT
=============================================
...
Sub-scores:
  • Component and feature org    : XX/6
  • Composables structure        : XX/6
  • Pinia store architecture     : XX/4
  • Router and lazy loading      : XX/4
  • Shared module separation     : XX/3
