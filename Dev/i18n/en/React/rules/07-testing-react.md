...
> **Current version: Playwright 1.60.0** — New features: composable fixtures, `toMatchAriaSnapshot()` for accessibility assertions, MCP server for Claude Code integration.
