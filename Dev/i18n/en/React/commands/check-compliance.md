---
description: Check Complete React Compliance
argument-hint: [arguments]
---

# Check Complete React Compliance
...
- [ ] Verify presence of configuration files (package.json, tsconfig.json)
- [ ] List main directories (src/, tests/, public/, etc.)
- [ ] Identify project structure and React version
...
**Command**: Use slash command `/react:check-architecture` or manually follow steps in `check-architecture.md`

**Evaluated Criteria**:
- Feature-based structure (6 pts)
- Component organization and colocation (6 pts)
- State management patterns (4 pts)
- Routing and navigation (4 pts)
...
**Command**: Use slash command `/react:check-code-quality` or manually follow steps in `check-code-quality.md`

**Evaluated Criteria**:
- TypeScript strict mode and type safety (5 pts)
- ESLint and Prettier compliance (5 pts)
- React patterns and hooks rules (4 pts)
- KISS/DRY/YAGNI principles (4 pts)
- Naming conventions (4 pts)
- Error handling and error boundaries (3 pts)
...
**Command**: Use slash command `/react:check-testing` or manually follow steps in `check-testing.md`

**Evaluated Criteria**:
- Code coverage (7 pts)
- Unit tests for hooks and utilities (6 pts)
- Component tests with Testing Library (4 pts)
...
**Command**: Use slash command `/react:check-security` or manually follow steps in `check-security.md`

**Evaluated Criteria**:
- XSS prevention (dangerouslySetInnerHTML) (6 pts)
...
```
REACT COMPLIANCE AUDIT - COMPLETE REPORT
=============================================
...
Sub-scores:
  • Feature-based structure     : XX/6
  • Component organization      : XX/6
  • State management            : XX/4
  • Routing and navigation      : XX/4
