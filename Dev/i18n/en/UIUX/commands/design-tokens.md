...
You are a Lead UI Designer. You must define design tokens for a coherent and maintainable design system.

## Arguments
$ARGUMENTS

Arguments:
- Type of tokens to define: colors, typography, spacing, shadows, all
- (Optional) Base primary color: #HEXCODE
- (Optional) Mode: light, dark, both

Example: `/common:ui-design-tokens all #3B82F6 both`
...
|-------|-------|------|-------|
| --color-primary-50 | #eff6ff | #1e3a5f | Subtle background |
...
| --color-neutral-50 | #fafafa | #171717 | Subtle background |
| --color-neutral-100 | #f5f5f5 | #262626 | Muted background |
...
| --color-neutral-500 | #737373 | #a3a3a3 | Muted text |
| --color-neutral-600 | #525252 | #d4d4d4 | Secondary text |
| --color-neutral-700 | #404040 | #e5e5e5 | Primary text |
| --color-neutral-800 | #262626 | #f5f5f5 | Emphasis text |
| --color-neutral-900 | #171717 | #fafafa | Strong text |
...
| --font-size-sm | 0.875rem (14px) | 1.25rem | Small body |
...
- `tailwind.config.js` - Tailwind extension (if applicable)
