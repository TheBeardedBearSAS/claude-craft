...
#### ❌ BAD: Over-engineering pour le futur
...
#### ✅ GOOD: Solution pour besoin actuel
...
// ✅ GOOD: Textes directs si une seule langue pour maintenant
<Text>Welcome</Text>
...
// ✅ GOOD: Constantes simples pour maintenant
export const colors = {
  primary: '#007AFF',
  white: '#FFFFFF',
  text: '#000000',
