...
#### ❌ BAD: Composant avec multiples responsabilités
...
#### ❌ BAD: Modification du composant pour chaque variant
...
#### ✅ GOOD: Extension via composition et configuration
...
#### ❌ BAD: Interface "fat" avec props inutiles
...
#### ❌ BAD: Dépendance directe aux implémentations
...
#### ✅ GOOD: Dépendance aux abstractions
