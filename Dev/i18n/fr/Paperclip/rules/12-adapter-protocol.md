...
>
> **Observé dans le dépôt** https://github.com/paperclipai/paperclip **(v2026.609.0).** Les APIs évoluent — en cas de doute, ouvrir le fichier `.d.ts` du package et la documentation officielle.
