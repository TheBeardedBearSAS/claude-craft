...
#### ❌ MAUVAIS: Over-engineering pour le futur
...
#### ✅ BON: Solution pour besoin actuel
...
// ✅ BON: Textes directs si une seule langue pour maintenant
<Text>Welcome</Text>
...
// ✅ BON: Constantes simples pour maintenant
export const colors = {
  primary: '#007AFF',
  white: '#FFFFFF',
  text: '#000000',
