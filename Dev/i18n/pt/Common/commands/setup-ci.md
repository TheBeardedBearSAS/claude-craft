...
- (Opcional) Tecnologias detectadas automaticamente
...
Escanear o projeto para identificar:
    ...
    steps:
      ...
      - name: Deploy to Staging
        run: |
          ...
          # Adicionar comandos de deployment
...
### Etapa 3: Configuração GitLab CI
...
### Etapa 4: Arquivos Complementares
...
1. Configurar secrets no GitHub/GitLab
2. Configurar environments (staging, production)
3. Adicionar comandos de deployment
4. Testar pipeline em um PR
```
