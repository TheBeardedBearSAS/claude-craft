...
> **Importante:** Usar `exit 2` (não `exit 1`) para bloquear efetivamente a chamada à ferramenta no Claude Code. `exit 1` apenas sinaliza um erro mas **não bloqueia** a execução.
