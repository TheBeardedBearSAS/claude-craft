...
Os testes garantem a qualidade e estabilidade da aplicação React Native.
...
### Testando Componentes de Apresentação
...
5. **Usar nomes de teste descritivos**
...
- [ ] Testes de integração (React Query)
- [ ] E2E Detox configurado
- [ ] Coverage > 80%

---

**Os testes não são opcionais, são essenciais.**
