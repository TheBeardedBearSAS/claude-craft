...
> Reference: `.claude/rules/01-architecture-ddd.md`, `.claude/rules/04-testing-tdd.md`
...
**Estimated time total:** 5 heures pour une feature moyenne

---

## Phase 1: Analysis pré-implémentation

### ✅ Analysis complète documentée
...
- [ ] **Acceptance criteria** (3-5 critères testables)
- [ ] **Impacted files** (nouveaux + modifiés)
- [ ] **Impacts identifiés:**
...
- [ ] Analysis relue par au moins 1 personne
...
## Phase 3: TDD - GREEN (Implementation minimale)
...
- [ ] Implementation minimale (pas de sur-engineering)
- [ ] Pas de code mort
...
## Example complet: Feature "Options payantes"
...
## Estimated times par taille de feature

| Taille | Analysis | TDD RED | TDD GREEN | REFACTOR | Validation | Total |
|--------|---------|---------|-----------|----------|------------|-------|
...
- [ ] Phase 1: Analysis documentée et validée
- [ ] Phase 2: Tests écrits (RED)
- [ ] Phase 3: Implementation minimale (GREEN)
