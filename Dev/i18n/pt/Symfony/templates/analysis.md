# Analysis pré-implémentation

> **Obligatoire avant toute implémentation** - Reference: `.claude/rules/03-coding-standards.md`
...
Si OUI:
- [ ] Requêtes N+1 potentielles → Check avec Symfony Profiler
...
Reference: `.claude/rules/01-architecture-ddd.md` et `.claude/rules/04-testing-tdd.md`
...
## Example concret Atoll Tourisme
