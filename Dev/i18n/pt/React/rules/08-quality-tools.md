...
> **⚠️ ESLint v10 (2026):** O formato legado `.eslintrc.cjs` foi **removido**. Usar `eslint.config.mjs` (flat config). Ver exemplo de migração na seção de ferramentas.

### Configuração .eslintrc.cjs (ESLint v9 e anterior)
