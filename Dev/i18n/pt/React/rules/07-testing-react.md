...
> **Versão atual: Playwright 1.60.0** — Novidades: fixtures componíveis, `toMatchAriaSnapshot()` para asserções de acessibilidade, servidor MCP para integração com Claude Code.
