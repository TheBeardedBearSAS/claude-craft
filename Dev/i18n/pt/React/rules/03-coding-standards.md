...
> **⚠️ ESLint v10 (2026):** O formato `.eslintrc.cjs` foi **removido**. Usar `eslint.config.mjs` (flat config). Ver a seção de ferramentas para o exemplo de migração.
...
### Configuração do .eslintrc.cjs (ESLint v9 e anterior)
