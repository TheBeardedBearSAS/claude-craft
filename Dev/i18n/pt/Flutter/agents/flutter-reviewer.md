...
description: Especialista em revisao de codigo Flutter 3.38 / Dart 3.10 — BLoC, Riverpod, otimizacao de widgets, codigo platform-specific
model: sonnet
...
```markdown
# Relatorio de auditoria Flutter 3.38 / Dart 3.10
