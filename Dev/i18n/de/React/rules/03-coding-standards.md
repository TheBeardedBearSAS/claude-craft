...
> **⚠️ ESLint v10 (2026):** Das Format `.eslintrc.cjs` ist **entfernt**. `eslint.config.mjs` (Flat Config) verwenden. Migrationsbeispiel im Tooling-Abschnitt.
...
### .eslintrc.cjs-Konfiguration (ESLint v9 und älter)
