...
> **⚠️ ESLint v10 (2026):** Das Legacy-Format `.eslintrc.cjs` ist **entfernt**. `eslint.config.mjs` (Flat Config) verwenden. Migrationsbeispiel im Tooling-Abschnitt.

### .eslintrc.cjs Configuration (ESLint v9 und älter)
