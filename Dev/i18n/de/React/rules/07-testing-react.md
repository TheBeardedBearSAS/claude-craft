...
> **Aktuelle Version: Playwright 1.60.0** — Neue Funktionen: komposable Fixtures, `toMatchAriaSnapshot()` für Barrierefreiheits-Assertions, MCP-Server für Claude Code Integration.
