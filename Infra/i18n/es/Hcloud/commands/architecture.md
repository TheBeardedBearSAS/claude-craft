...
- Restricciones (p. ej., budget, datacenter, compliance)

Ejemplo: `/hcloud:architecture "Plataforma de e-commerce" workload:web-application datacenter:fsn1 budget:100eur`
